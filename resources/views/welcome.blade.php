...
<body>
    <div class="bg-white">
            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="text-3xl font-bold text-gray-900">Career<span
                                class="text-indigo-600 font-playfair">connect</span></span>
                    </a>
                </div>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10">
                            <div class="space-y-2 py-6">
                                ...
                                <a href="#"
                                    class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Jobs</a>

                                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Company</a>
                            </div>
                            <div class="py-6">
                                <a href="#"
                                    class="-mx-3 block rounded-lg px-10 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Log
                                    in</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8 lg:grid lg:grid-cols-2 lg:gap-10">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48">
                <div>
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Building the <span
                            class="text-indigo-600 font-playfair">Future</span>
                        Together.
                    </h1>
            ...
            <div>
                <img src="./images/students_reading.jpg" class="mt-28 rounded-3xl">
            </div>
